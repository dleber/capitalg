...
class Writer:
    ...
    def __init__(self, cgt_events_path: str, cost_base_path: str):
        ...
        self.cgt_events_writer = csv.DictWriter(self.cgt_events_handler,
                                                OUTPUT_FIELDS_CGT_EVENTS)
        ...
        self.cost_base_writer = csv.DictWriter(self.cost_base_handler,
                                               OUTPUT_FIELDS_COST_BASE)
    ...
    def write_cgt_event(self, cost_base: dict, sale: dict):
        self.cgt_events_writer.writerow({
            ...
            sale[FIELD_EXCHANGE],
            FIELD_COST_BASE_ID:
            cost_base[FIELD_COST_BASE_ID],
            FIELD_ASSET_CODE:
            sale[FIELD_ASSET_CODE],
            FIELD_QTY:
            sale[FIELD_QTY],
            FIELD_PRICE:
            sale[FIELD_PRICE],
            FIELD_SALE_AMOUNT:
            sale[FIELD_QTY] * sale[FIELD_PRICE],
            FIELD_SALE_BROKERAGE:
            sale[FIELD_FEE],
            FIELD_COST_BASE_AMOUNT:
            cost_base[FIELD_COST_BASE_AMOUNT],
            FIELD_CAPITAL_GAIN_TOTAL:
            cost_base[FIELD_CAPITAL_GAIN_TOTAL],
            FIELD_CAPITAL_GAIN_LT:
            cost_base[FIELD_CAPITAL_GAIN_LT],
            FIELD_CAPITAL_GAIN_ST:
            cost_base[FIELD_CAPITAL_GAIN_TOTAL] -
            cost_base[FIELD_CAPITAL_GAIN_LT],
            FIELD_NOTE:
    ...
    def write_cost_base_transactions(self, cost_base_id: str,
                                     cost_transactions: List[dict]):
    ...
    @staticmethod
    def output_unallocted_cost_base_transactions(output_file: Path,
                                                 queues: dict):
        headers = [
            FIELD_DATE,
            FIELD_ASSET_CODE,
