...
def main():
    ...
    cg_parser.add_argument('-c', '--tax_currency', help='Currency in which tax is to be paid', required=True, type=str)
    ...
    balance_subparser.add_argument('-c', '--tax_currency', help='Currency in which tax is to be paid', required=True, type=str)
